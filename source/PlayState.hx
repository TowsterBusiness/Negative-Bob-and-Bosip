	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'day':
				{
						defaultCamZoom = 0.75;
						curStage = 'day';
						var bg1:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('day/background', 'shared'));
						...
						var bg2:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('day/midground', 'shared'));
						...
						var bg3:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('day/foreground', 'shared'));
			...
			case 'sunset':
				{
					defaultCamZoom = 0.75;
					curStage = 'day';
					var bg1:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('sunset/BG1', 'shared'));
					bg1.antialiasing = true;
					bg1.scale.set(0.8, 0.8);
					bg1.scrollFactor.set(0.5, 0.5);
					bg1.active = false;
					...
					var bg2:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('sunset/BG2', 'shared'));
					bg2.antialiasing = true;
					bg2.scale.set(0.8, 0.8);
					bg2.scrollFactor.set(0.8, 0.8);
					bg2.active = false;
			...
			case 'night':
			{
				...
				var bg1:FlxSprite = new FlxSprite(-19, -400).loadGraphic(Paths.image('night/BG1', 'shared'));
				bg1.antialiasing = true;
				bg1.scale.set(0.8, 0.8);
				bg1.scrollFactor.set(0.3, 0.3);
				bg1.active = false;
				...
				var bg2:FlxSprite = new FlxSprite(-578, -282).loadGraphic(Paths.image('night/BG2', 'shared'));
				bg2.antialiasing = true;
				bg2.scale.set(0.8, 0.8);
				bg2.scrollFactor.set(0.6, 0.6);
				bg2.active = false;
				...
				var bg3:FlxSprite = new FlxSprite(-600, -300).loadGraphic(Paths.image('night/BG3', 'shared'));
				bg3.antialiasing = true;
				bg3.scale.set(0.8, 0.8);
				bg3.active = false;
				theEntireFuckingStage.add(bg3);

				var bg4:FlxSprite = new FlxSprite(-630, -410).loadGraphic(Paths.image('night/BG4', 'shared'));
				bg4.antialiasing = true;
				bg4.scale.set(0.8, 0.8);
				bg4.scrollFactor.set(0.8, 0.8);
				bg4.active = false;
				...
				pc = new Character(115, 96, 'pc');
				pc.scrollFactor.set(0.8, 0.8);
				pc.debugMode = true;
