...
class Paths
{
	...
	inline static public function getSparrowAtlas(key:String, ?library:String, ?isCristmas)
	{
		return isCristmas ? FlxAtlasFrames.fromSparrow('christmas/images/characters/$key.png', 'christmas/images/characters/images/$key.png') : FlxAtlasFrames.fromSparrow(image(key, library), file('images/$key.xml', library));
	}
