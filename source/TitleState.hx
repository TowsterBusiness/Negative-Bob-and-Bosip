...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		bg.frames = Paths.getSparrowAtlas('titlemenu/startscreenbg');
		bg.animation.addByPrefix('slide', 'startscreenbg idle0', 24, true);
		bg.animation.play('slide');
		...
		bob.frames = Paths.getSparrowAtlas('titlemenu/Start_Screen_Bob_Assets');
		bob.animation.addByPrefix('idle', 'negative bob dancing beat', 24, false);
		bob.x += 80;
		bob.y += 120;
		...
		bosip.frames = Paths.getSparrowAtlas('titlemenu/Start_Screen_Bosip_Assets');
		bosip.animation.addByPrefix('idle', 'negative bosip dancing beat', 24, false);
		bosip.x -= 50;
	...
	function outTransition()
	{
		...
		FlxTween.tween(bg, {alpha: 0}, 0.4, {ease: FlxEase.quadIn, startDelay: 0.8,});
